...
namespace UltraCold
{
    namespace GPSolvers
    {
                                         ...
                                         double alpha)
        {
               ...
               psi.extent(1) != ny || this->Vext.extent(1) != ny )
            {
                cout
                        << "\n\n"
                        << "*********************************************************************************\n"
                        << "Error found in the constructor of a DipolarGPSolver for a Gross-Pitaevskii\n"
                                                      ...
                                                      ostream& output_stream)
        {
            ...
            size_t it;
            RealSpaceOutput::DataOut phidd_out;
            FourierSpaceOutput::DataOut psitilde_out;
...
#pragma omp parallel for
        ...
        */
        ...
        void DipolarGPSolver::run_operator_splitting(int, double, double, ostream&){};
        ...
        */
        ...
        void DipolarGPSolver::run_operator_splitting(int, double, double, double, ostream&){};
        ...
        */
        ...
        void DipolarGPSolver::run_operator_splitting(int, double, double, double, double, ostream&){};
                                                              ...
                                                              ostream& output_stream)
        {
            ...
            if(iteration_number % 100 == 0)
            {
                ...
                psi_out.set_output_name("psi_real"+std::to_string(iteration_number/100));
                psi_out.write_vtk(x,y,psi,"psi");
            }
